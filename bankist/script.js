...
btnScrollTo.addEventListener('click', function (e) {
  ...
  // // window.scrollTo(
  // //   s1coords.left + windows.pageXOffset,
  ...
  section1scrollIntoView({ behaviour: 'smooth' });
});
...
//     console.log(id);
//     document.querySelector(id).section1scrollIntoView({
//       behaviour: 'smooth',
//     });
//   });
// });
...
// 2. determine wgat element oroginated event
...
const slider = function () {
  ...
  // const slider = document.querySelectro('.slide');
